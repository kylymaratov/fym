...
export const Range: React.FC<Props> = ({
  ...
  return (
    <div
      ...
      className={`rounded-lg bg-gray-700 h-2 cursor-pointer overflow-hidden relative z-10 ${
    ...
    >
      <div
        ...
        className="h-2 w-2 top-[50%] translate-y-[-50%]  rounded-full bg-blue-400 absolute z-10"
      ></div>
      <div
        className="bg-blue-400 absolute top-0 left-0 h-full rounded-full z-0"
        style={{
