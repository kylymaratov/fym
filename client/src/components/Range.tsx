import { Times } from '@/features/AudioPlayer/hooks/UserPlayer';
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute h-full w-[10px] bg-blue-600 transition-all duration-300 z-30"
      ></div>
      <div
        className="absolute top-0 left-0 h-full bg-blue-600 transition-all duration-300 z-30"
